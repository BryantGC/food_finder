...
server.post('/getplaces',(req, res) => {
  ...
  axios.get(locationReq).then((response) => {
    ...
    const placesReq = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${locationData.lat},${locationData.lng}&radius=1500&types=${placetype}&key=${PLACES_API_KEY}`;
